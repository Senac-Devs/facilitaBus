function startSelection() {
    const colorSelected = getComputedStyle(
        document.documentElement
    ).getPropertyValue("--color-button-selected");
...
function updateButton() {
    ...
    const colorDeselected = getComputedStyle(
        document.documentElement
    ).getPropertyValue("--color-button-deselected");
